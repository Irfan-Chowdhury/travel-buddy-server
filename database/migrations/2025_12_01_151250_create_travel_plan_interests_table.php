...
return new class extends Migration
{
    ...
    {
        Schema::create('travel_plan_interests', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::table('travel_plan_interests', function (Blueprint $table) {
            $table->dropForeign(['travel_plan_id']);
            $table->dropForeign(['interest_id']);
        });

        Schema::dropIfExists('travel_plan_interests');
    }
};
